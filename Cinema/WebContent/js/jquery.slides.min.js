    ...
    (function(e, t, n) {
        ...
        r.prototype.init = function() {
            ...
            if (this.options.navigation.active) {
                o = e("<a>", {"class": "slidesjs-previous slidesjs-navigation", href: "#", title: "Previous", text: "Previous"});
                r = e("<a>", {"class": "slidesjs-next slidesjs-navigation", href: "#", title: "Next", text: "Next"});
            }
            ...
            if (this.options.play.active) {
                s = e("<a>", {"class": "slidesjs-play slidesjs-navigation", href: "#", title: "Play", text: "Play"});
                u = e("<a>", {"class": "slidesjs-stop slidesjs-navigation", href: "#", title: "Stop", text: "Stop"});
                s.click(function(e) {
                    e.preventDefault();
                    return a.play(!0)
                });
            ...
            if (this.options.pagination.active) {
                ...
                e.each(new Array(this.data.total), function(t) {
                    var n, r;
                    n = e("<li>", {"class": "slidesjs-pagination-item"});
                    r = e("<a>", {href: "#", "data-slidesjs-item": t, html: t + 1});
